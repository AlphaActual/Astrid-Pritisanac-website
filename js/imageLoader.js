                            ...
                            <div class="row justify-content-center align-items-center">
                                ...
                                <div class="col-12 col-lg-4 col-xxl-4 mt-5 mt-md-0 d-flex justify-content-center">
                                    <div class="centering-div text-start font-Caveat fs-4">
                                        <div class="direction-buttons text-center mb-2 d-lg-none">
                                            <a class="btn btn-prev text-primary mx-2  align-self-center"><i class="fas fa-chevron-left top-icon fa-2x" style="pointer-events: none"></i></a>
                                            <a class="btn btn-next text-primary mx-2  align-self-center"><i class="fas fa-chevron-right top-icon fa-2x" style="pointer-events: none"></i></a>
                                        </div>
